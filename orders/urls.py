...
from orders.views import checkout, order_detail, print_receipt, add_to_cart, cart, add_to_cart_from_animal_detail, remove_from_cart, increase_quantity, decrease_quantity, orders, confirm_payment
